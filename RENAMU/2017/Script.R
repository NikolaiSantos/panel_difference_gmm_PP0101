...
# Definir ruta base
#ruta_base <- "/home/nikolai/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2017/"
ruta_base <- "D:/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2017"
...
columnas_deseadas <- c("P18_5", "P20", "P21_2_T", "P25_1", "P25_2", "P64A_1", "P64A_2", "P64A_3",
...
write_xlsx(resultado, path = file.path(ruta_base, "RENAMU_2017.xlsx"))
write.csv(resultado, file = file.path(ruta_base, "RENAMU_2017.csv"),
...
cat(sprintf("Archivo exportado como: %s\n", file.path(ruta_base, "RENAMU_2017.xlsx")))
