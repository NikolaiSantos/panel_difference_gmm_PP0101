...
# Definir ruta base
#ruta_base <- "/home/nikolai/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2019/"
ruta_base <- "D:/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2019"
...
columnas_deseadas <- c("P17_4", "P19", "P20_2_T", "P23_1", "P23_2", "P59_1_1", "P59_2_1", "P59_3_1",
...
write_xlsx(resultado, path = file.path(ruta_base, "RENAMU_2019.xlsx"))
write.csv(resultado, file = file.path(ruta_base, "RENAMU_2019.csv"),
...
cat(sprintf("Archivo exportado como: %s\n", file.path(ruta_base, "RENAMU_2019.xlsx")))
