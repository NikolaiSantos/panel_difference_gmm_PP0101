...
# Definir ruta base
#ruta_base <- "/home/nikolai/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2020/"
ruta_base <- "D:/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2020"
...
columnas_deseadas <- c("P16_4", "P18", "P19_2_T", "P23_1", "P23_2", "P59_1_1", "P59_2_1", "P59_3_1", 
                       "P59_4_1", "P59_5_1", "P59_6_1", "P59_7_1", "P59_8_1", "P59_9_1", "P59_10_1", "P59_11_1",
                       "P100_4", "P102", "P102_2")
...
columnas_ordenadas <- c("idmunici", "Tipomuni", columnas_deseadas)
resultado <- resultado %>% select(all_of(columnas_ordenadas))

str(resultado)
# Exportar el resultado
write_xlsx(resultado, path = file.path(ruta_base, "RENAMU_2020.xlsx"))
write.csv(resultado, file = file.path(ruta_base, "RENAMU_2020.csv"), 
...
cat(sprintf("Archivo exportado como: %s\n", file.path(ruta_base, "RENAMU_2020.xlsx")))
