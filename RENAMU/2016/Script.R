...
# Definir ruta base
#ruta_base <- "/home/nikolai/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2016/"
ruta_base <- "D:/Dropbox/Trabajos/TESIS MAESTRIA/Tesis 2/Datasets/RENAMU/2016"
...
write_xlsx(resultado, path = file.path(ruta_base, "RENAMU_2016.xlsx"))
write.csv(resultado, file = file.path(ruta_base, "RENAMU_2016.csv"),
...
cat(sprintf("Archivo exportado como: %s\n", file.path(ruta_base, "RENAMU_2016.xlsx")))
