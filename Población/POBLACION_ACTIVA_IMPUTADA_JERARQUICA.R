...
ruta_archivo <- "POBLACION_ACTIVA_2007-2024.xlsx"
datos <- read_excel(ruta_archivo, sheet = "POBLACION_ACTIVA") %>%
  mutate(
...
writexl::write_xlsx(datos_completos, "POBLACION_ACTIVA_IMPUTADA.xlsx")
cat("\nImputación completada y resultados guardados en 'POBLACION_ACTIVA_IMPUTADA.xlsx'")