...
ruta_archivo <- "POBLACION_VARONES_2007-2024.xlsx"
datos <- read_excel(ruta_archivo, sheet = "POBLACION_VARONES") %>%
  mutate(
...
writexl::write_xlsx(datos_completos, "POBLACION_VARONES_IMPUTADA.xlsx")
cat("\nImputación completada y resultados guardados en 'POBLACION_VARONES_IMPUTADA.xlsx'")